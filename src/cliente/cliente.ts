...
import { CrearPrestamoRequestDto, ErrorRespondeDto, PrestamoResponseDto } from "../contrato/prestamo-response.dto.js";
...
form.addEventListener('submit', async (ev) => {
  ...
  if (res.status === 201) {
    ...
    const error = (await res.json()) as ErrorRespondeDto;
